...
if( is_archive() && $template_name === 'archive.php' ) {
	...
	post_class( 'grid-item yhei-grid-item col-6-12-custom mobile-col-6-12 small-col-1');
} else {
...
?> itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
	...
	<div class='post-thumb'>
		...
		<?php else: ?>
			<img width="800" height="640" src="<?php echo get_stylesheet_directory_uri(); ?>/img/yhei_web_design_catch-800x640.jpg" class="attachment-draft-portfolio-thumbnail size-draft-portfolio-thumbnail wp-post-image" alt="<?= $category_name ?>" />
		<?php endif; ?>
		</a>
	</div>
